...
export function ichimokukinkouhyou(input) {
    const { high, low, conversionPeriod = 9, basePeriod = 26, spanPeriod = 52, displacement = 26 } = input;
...
IchimokuKinkouhyou.calculate = ichimokukinkouhyou;
